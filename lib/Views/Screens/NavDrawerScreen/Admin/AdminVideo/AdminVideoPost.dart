                  ...
                  GetBuilder<AdminVideoController>(
                    builder: (adminVideoController) {
                      return DropdownButton(
                        isExpanded: true,
                        hint: Text(
                          edit == "edit" ? startImg : "Starting Image",
                          style: TextStyle(fontSize: 14, color: Colors.black),
                        ),
                        items: adminVideoController.dropDpwnShow.keys.map(
                          (values) {
                            return DropdownMenuItem(
                              value: values,
                              child: Padding(
                        ...
                        onChanged: (valueSelectedByUser) {
                          ...
                          adminVideoController.onchangedDropDnStartingImage(
                  ...
                  GetBuilder<AdminVideoController>(
                    builder: (adminVideoController) {
                      return DropdownButton(
                        ...
                        onChanged: (valueSelectedByUser) {
                          adminVideoController
                              .onchangedDropDnEndingImage(valueSelectedByUser,context);
                        },
                      );
                    },
                  ),
                    ...
                    builder: (adminVideoController) {
                      return DropdownButton(
                        ...
                        hint: Text(
                          edit == "edit"
                              ? publish
                              : "Do you want to Publish the Video ?",
                          style: TextStyle(fontSize: 14, color: Colors.black),
                        ),
                        items: adminVideoController.dropDpwnShow.keys.map(
                          (values) {
                        ...
                        onChanged: (valueSelectedByUser) {
                          adminVideoController
                              .onchangedDropDnPulish(valueSelectedByUser,context);
                        },
                      );
                    },
                  ),
